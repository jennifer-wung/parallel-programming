...
int main(int argc, char *argv[]) {
	...
	int chunckSz = height/numThreads;
	//cout << "chunck size = "<<chunckSz<<endl;
	...
	#pragma omp parallel private(iam, np)//shared(imag_min, real_min, scale_imag, scale_real)
	{
		...
		#pragma omp for private(repeats,lengthsq,temp, c,z) schedule(static,chunckSz)
	...
	cout << "Time elaspsed: "<<totalEndwtime-totalStartwtime<<endl;
        //for(int k = 0; k <numThreads; k++)
        //        cout << "threadID["<<k<<"] = "<<delta_t[k]<<endl;
