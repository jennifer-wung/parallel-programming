...
void slave(int row_work, int width, int height, double real_min, double real_max, double imag_min, double imag_max,int rank, int nprocs);
...
int main(int argc, char *argv[]) {
	...
	if( rank == 0 ) { // Master
		...
		slave(row_work, resol_x, resol_y, real_min, real_max, imag_min, imag_max,rank, nprocs);
	}
	if (rank == 0) {
